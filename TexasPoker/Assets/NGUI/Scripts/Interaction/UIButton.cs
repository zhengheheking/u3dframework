...
public class UIButton : UIButtonColor
{
    ...
    private Vector3 m_PressScale = new Vector3(1.1f, 1.1f, 0.5f);
	...
	protected override void OnInit ()
	{
		...
		if (mSprite2D != null) mNormalSprite2D = mSprite2D.sprite2D;
        m_NormalScale = new Vector3(tweenTarget.transform.localScale.x, tweenTarget.transform.localScale.y, tweenTarget.transform.localScale.z);
	}
    ...
    protected override void OnPress(bool isPressed)
    {
        ...
        if (isPressed)
        {
            ...
            Vector3 pressScale = new Vector3(m_NormalScale.x * m_PressScale.x, m_NormalScale.y * m_PressScale.y, m_NormalScale.z * m_PressScale.z);
            TweenScale ts = TweenScale.Begin(tweenTarget, duration, pressScale);
        }
        else
        {
            TweenScale ts = TweenScale.Begin(tweenTarget, duration, m_NormalScale);
